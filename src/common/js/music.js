	...
	init:function(){
		...
		this.testJson = {
						list:[
								...
								{src:"ywaq.jpg",title:"浮夸",song:"fukua",singer:"陈奕迅"},
								{src:"hs.jpg",title:"好久不见",song:"haojiubujian",singer:"陈奕迅"},
								{src:"cr.jpg",title:"如果没有你",song:"ruguomeiyouni",singer:"莫文蔚"},
							]
						};
	...
	loadDate:function(oList){
		switch(this.type){
			...
			case 1:this.ulTarget.append('<li onclick="myControl.selectList(this,'+this.stack+')">'
									  +	'<div class="frp-box dot"><div class="frmLoad scb play-btn"></div></div>'
									  +'<div class="frp-box dot"><div class="frmPlay scb play-btn"></div></div>'
									  ...
									  + '<div class="mu-l"><img class="picStyle" src="'+this.imgPath+oList[this.stack].src+'"/></div>'
